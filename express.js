 ...
 * @Date: 2024-07-17 16:34:51
 * @LastEditors: 孙浩林 sunhaolin@steedos.com
 * @LastEditTime: 2024-07-17 19:14:11
...
(async () => {
    ...
    server = app.listen(PORT, () => {
        console.log(require('chalk').green(`application is listening on port ${PORT}, check its /.well-known/openid-configuration`));
    });
})().catch((err) => {
